...
console.log(
  "We can chain methods: s1.toLowerCase().lastIndexOf('w') = " +
    s1.toLowerCase().lastIndexOf("w")
); // we can chain method calls using ‘.’
...
result = ar.join(".");
console.log(
  "ar.join('.') will return a string made of the array elements returned joined by '.'"
);
